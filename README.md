 ...
 **"Название компании"**: выбрать тип **"Наименование организации одной строкой"**. Подсказки будут советовать название компании при вводе и автоматически заполнят поля с типами **ИНН**, **КПП** и пр. (полный список полей приведен на скриншоте). 
* Сохраните изменения.
