            ...
            initSuggestionFields = function () {
                ...
                if ($(<?=CDadataSuggestions::fieldSelector($fieldNo)?>).length > 0) $(<?=CDadataSuggestions::fieldSelector($fieldNo)?>).suggestions({
                    ...
                    onSelect: function (suggestion) {
                        ...
                        if ($(<?=CDadataSuggestions::fieldSelector($innerFieldNo)?>).length > 0) dadataSearchLocation(suggestion.data.city, suggestion.data.region, suggestion.data.country, 'ORDER_PROP_<?=$innerFieldNo?>');
